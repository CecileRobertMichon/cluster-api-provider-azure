...
// This is meant to be called for each reconcile iteration.
func (s *ClusterScope) NewMachineScope(params MachineScopeParams) (*MachineScope, error) {
...
// This is meant to be called for each reconcile iteration.
func (s *ClusterScope) NewMachinePoolScope(params MachinePoolScopeParams) (*MachinePoolScope, error) {
	if params.Client == nil {
